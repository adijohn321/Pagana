        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p>We deliver the best services to our clients and make sure they are comfy in the rooms.</p>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h5 class="text-white mb-4">Contact</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Rufo Mañara St., RH XI, Cotabato City, near
                        Grecco Gas Station.</p>
                    ...
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social"
                            href="https://www.facebook.com/paganakutawatonativerestaurant"><i
