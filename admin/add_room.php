...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include_once "../function/add_room.php";
    ...
    if (insertRoom($name, $type, $description, $rate)) {
                            ...
                            <div class="card-body">
                                <form action="add_room.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" required value="<?php echo isset($_SESSION['errors']['name']) ? '' : (isset($_POST['name']) ? $_POST['name'] : ''); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="type" name="type" required value="<?php echo isset($_SESSION['errors']['type']) ? '' : (isset($_POST['type']) ? $_POST['type'] : ''); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" id="description" name="description" required><?php echo isset($_SESSION['errors']['description']) ? '' : (isset($_POST['description']) ? $_POST['description'] : ''); ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="rate" name="rate" required value="<?php echo isset($_SESSION['errors']['rate']) ? '' : (isset($_POST['rate']) ? $_POST['rate'] : ''); ?>">
                                        <?php if (isset($_SESSION['errors']['rate'])) { ?>
                                            <div id="rate-error" style="color: red; font-size: 14px;"><?php echo $_SESSION['errors']['rate']; ?></div>
                                        <?php } ?>
                                    </div>
                                    <div class="mb-3">
                                        <label for="image" class="form-label">Main Image <span style="color: red;">*</span></label>
