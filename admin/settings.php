    ...
    <div class="home-content" style="overflow: hidden;">
        <div class="tables table-responsive">
          <div style="margin-bottom: 20px;">            
            <a class="btn btn-primary" href="add_about.php">About Us</a>
          </div>
            <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td style="text-align: center; text-transform: capitalize "><?php echo substr($aboutDescription, 0 , 100); ?>...</td>
                      <td style="text-align: center; text-transform: capitalize "><?php echo $aboutType; ?></td>
                      <td style="text-align: center; text-transform: capitalize ">
                          <a href="edit_about.php?id=<?php echo $aboutId; ?>" class="btn btn-primary">Edit</a>
                          <a href="settings.php?id=<?php echo $aboutId; ?>" class="btn btn-danger">Delete</a>
                      </td>
                  </tr>
                  <?php
                  }
