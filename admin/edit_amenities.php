...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  include_once "../function/edit_amenities.php";

  // Update room information
  $newName = $_POST['name'];
  $newRate = $_POST['rate'];

    if (updateAmenities($newName, $newRate, $id)) {
      // Room inserted successfully
      $_SESSION['success'] = "Amenities updated successfully.";
  } else {
      // Failed to insert room
      $_SESSION['error'] = "Failed to update amenities.";
  }
}
?>
        ...
        <div class="tables">
          <div style="margin-bottom: 20px;">            
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">Edit Amenities</div>
                            ...
                            <div class="card-body">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" required value="<?php echo $amenitiesName; ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="rate" name="rate" required value="<?php echo $amenitiesRate; ?>">
