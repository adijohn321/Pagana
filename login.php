...
if (isset($_SESSION['user_id']) && $_SESSION['role'] === "Administrator" ) {
    ...
    //header("Location: Guest/landingpage.php");
...
<head>
    <meta charset="utf-8">
    <title>Login | Pagana Hotel</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <h5>Maximum Login attemps reached! Try reloading this page after <?php echo $multiplier?> minute/s.</h5>
                        ...
                        <?php if  (!empty($error_message)) { ?>
                            <div id="alert" style="color: red;" class="alert alert-danger"><?php echo $error_message; ?></div>
                        <?php } ?>
                        <div class="card-body">
