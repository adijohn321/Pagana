                    ...
                    <div class="col-md-10">
                      <div class="row g-2">
                        <div class="col-md-6">
                          ...
                          <input type="date" id="checkin" class="form-control border-0" name="checkin"
                            max="<?php echo $fdate; ?>" value="<?php echo $checkin; ?>" placeholder="Keyword" />
                        </div>
                        <div class="col-md-6">
                          <label style="color: white;">To:</label>
                          <input type="date" id="checkout" class="form-control border-0" name="checkout"
                            max="<?php echo $fdate; ?>" value="<?php echo $checkout; ?>" placeholder="Keyword" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-2">
            ...
            <tbody>
              ...
              if (mysqli_num_rows($fetch_booked) > 0) {
                while ($fetch = mysqli_fetch_assoc($fetch_booked)) {
                  ...
                  ?>
                  <tr>
                    <td style="text-align: center; text-transform: capitalize "><img
                        src="../uploads/<?php echo $select_arr[$fetch['name']]['image']; ?>" width="50" height="50"></td>
                    ...
                    <td style="text-align: center; text-transform: capitalize ">₱
                      <?php echo $select_arr[$fetch['name']]['rate']; ?>
                    </td>
                    <td style="text-align: center; text-transform: capitalize ">
                      <a href="room_booking1.php?id=<?php echo $select_arr[$fetch['name']]['id']; ?>&checkin=<?php echo $checkin; ?>&checkout=<?php echo $checkout; ?>"
                        class="btn btn-secondary">Book</a>
                      <a href="reserveRoom.php?id=<?php echo $select_arr[$fetch['name']]['id']; ?>&checkin=<?php echo $checkin; ?>&checkout=<?php echo $checkout; ?>"
