            ...
            <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr class="reservation-row" data-status="<?php echo $reservationStatus; ?>">
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationTransaction; ?></td>
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationRoom; ?></td>
                      ...
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationName; ?></td>
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationPhone; ?></td>
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationIn; ?></td>
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationOut; ?></td>
                      <td style="text-align: center; text-transform: capitalize ">₱<?php echo $reservationAmount; ?></td>
                      <td style="text-align: center; text-transform: capitalize ">₱<?php echo $reservationTotal; ?></td>
                      <td style="text-align: center; text-transform: capitalize "><?php echo $reservationStatus; ?></td>
                      <td class="action-column" style="text-align: center; text-transform: capitalize;">
                      <div class = "AR" style="display:flex">
                        <button class="btn btn-primary" onclick="updateReservationStatus('<?php echo $reservationTransaction; ?>')">Accept</button> 
                        <button class="btn btn-danger" onclick="rejectReservationStatus('<?php echo $reservationTransaction; ?>')">Reject</button>
                      </div>
                      <div class = "A" style="display:flex">
                        <a href="room_booking.php?id=<?php echo $reservationRoom?>&checkin=<?php echo $reservationIn; ?>&checkout=<?php echo $reservationOut; ?>&name=<?php echo $reservationName; ?> &email=<?php echo $reservationEmail; ?>&phone=<?php echo $reservationPhone; ?> &address=<?php echo $reservationAddress; ?>&rid=<?php echo $reservationId; ?>&total=<?php echo $reservationTotal?>" class="btn btn-primary">Book</a>
                      </div>
                      </td>
                  </tr>
                  <?php
