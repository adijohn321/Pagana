        ...
        <div class="row">
            ...
            <div class="reservation-form">
                ...
                <div class="form-group">
                    ...
                    <label><input type="text" id="rate" class="form-control" name="rate" value="<?php echo $newRate; ?>" readonly></label>
                </div>

                <br>
                <button type="submit" name="submit" class="form-control">Reserve Room</button>
